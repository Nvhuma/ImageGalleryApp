...
function Register() {
  ...
  const [qrCode, setQrCode] = useState(''); // State for QR Code for the TIME BASED ONE TIME PIN 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //the backend returns the QR code and base32 secret
      ...
      if (error.response) {
        ...
        setError(error.response.data.Message || 'Password is too short, Password should be atleast 15 characters');
