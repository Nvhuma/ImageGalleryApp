...
const ImageUpload = () => {
  ...
  // Handle form submission (when a user clicks "Submit")
  const handleUpload = async (e) => {
    ...
    try {
      ...
      //  Sending the image metadata and Cloudinary URL to the backend API
      ...
      setSuccessMessage(`Image saved successfully! ${imageSelected.name} - ${(imageSelected.size / 1024).toFixed(1)}KB`); 
