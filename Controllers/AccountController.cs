...
namespace api.Controllers
{
	...
	public class AccountController : ControllerBase
	{
		...
		public async Task<IActionResult> VerifyTotp(TotpDto totpDto)
		{
			...
			//the TOTP code will be accepted if it is valid within a 2-time-step window before or after the current time. 
    ...
    ";
		...
		public async Task<IActionResult> ResetPassword(ResetPasswordDto resetPasswordDto)
		{
			...
			// Checks if the new password is the same as any previous passwords
			...
			// Saving the old password hash to the password history table
